 ...
 * files), carried over from RAVE RAID: one family, three weights,
 * everywhere text is painted onto a canvas. 700 carries headlines and
 * CTAs, 600 carries interactive labels, 500 carries reading text. Weight
 * does the hierarchy work. It already looks like it was stencilled onto
 * plant hardware, which is exactly the shop TUBES runs.
 *
...
// Kick the load at module import — the board is the first thing painted.
(() => {
