...
/**
 * One anchor's departure from the BOXER pose:
 *   [anchor, dx, dy, dz, radiusScale]
 * Vendored from GOOP's fight-styles layer, which TUBES has no use for —
 * the shape of a delta is all the dance needs.
 */
